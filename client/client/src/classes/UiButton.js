...
export default class UiButton extends Phaser.GameObjects.Container {
	constructor(scene, x, y, key, hoverKey, text, targetCallback) {
		...
		this.hoverKey = hoverKey; // the image that will be displayed when user hovers over the button
		this.text = text; // the text that will be displayed on the button
		this.targetCallback = targetCallback; // callback function called when user clicks the button
